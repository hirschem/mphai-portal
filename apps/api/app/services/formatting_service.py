...
PROMPT_PREFIX = (
    ...
    "\"client\"\n"
        prompt = (
            ...
            "\n"
            "If the input contains a client/customer name or address anywhere, the output must begin with:\n"
            "Client: <name>\n"
            "Address: <address>\n"
            "If not present, omit those lines (do not invent).\n"
            "\n"
            "Include EVERY scope/line item from the input. Do not omit items.\n"
            "Amount reliability:\n"
            "- Do not guess amounts.\n"
            "- If an amount is unclear or missing, use TBD instead of a dollar value.\n"
            "- Do NOT interpret patterns like ‘@ 3’, ‘L03/L04 @ 3’, or similar as $3.00.\n"
            "\n"
            "Pricing Rules:\n"
